...
?>
@extends('../admin.layout.master',['pageData'=>$pageData])
                ...
                <div class="col-sm-12">
                    <div class="text-center error-box">
                        ...
                        <p class="font-md">
                            ...
                            @if(\Request::is('story-admin/*'))
                                <a href="{{URL::to('/story-admin/')}}" class="btn btn-labeled btn-default"> <span
                                            class="btn-label"><i class="glyphicon glyphicon-chevron-left"></i></span>Back
                                    To
                                    Home
                                </a>
                            @else
                                <a href="{{URL::to('/')}}" class="btn btn-labeled btn-default"> <span
                                            class="btn-label"><i class="glyphicon glyphicon-chevron-left"></i></span>Back
                                    To
                                    Home
                                </a>
