...
class StoryCommenterReplyNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $storyTitle = $this->story['story_title'];

        $msg = new MailMessage();
        $msg->subject("Story Comment Notification");
        $msg->line(\Auth::user()->name . ' has posted a reply on your comment on "' . $storyTitle . '" story:  <br/>');
